...
* Species categories: `r levels(penguins$species)`
* Island categories: `r levels(penguins$island)`
* Bill length minimum and maximum value (in mm): `r range(penguins$bill_length_mm, na.rm = TRUE)`
* Bill depth minimum and maximum value (in mm): `r range(penguins$bill_depth_mm, na.rm = TRUE)`
* Flipper length minimum and maximum value (in mm): `r range(penguins$flipper_length_mm, na.rm = TRUE)`
* Body mass minimum and maximum value (in g): `r range(penguins$body_mass_g, na.rm = TRUE)`
* Sex categories: `r levels(penguins$sex)`
* Year categories: `r range(penguins$year)`
